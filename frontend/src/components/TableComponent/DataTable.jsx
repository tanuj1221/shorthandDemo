...
//       const response = await axios.get(`http://dev.shorthandexam.in/table/${tableName}`, {
//         headers: {
...
//         `http://dev.shorthandexam.in/table/${tableName}/add`,
//         newRecord,
//         {
//           headers: {
//             Authorization: 'Bearer dummy-token',
...
//         `http://dev.shorthandexam.in/table/${tableName}/delete`,
//         {
//           data: recordToDelete,
//           headers: {
//             Authorization: 'Bearer dummy-token',
...
//         `http://dev.shorthandexam.in/table/${tableName}`,
//         preparedChanges,
//         {
//           headers: {
//             Authorization: 'Bearer dummy-token',
